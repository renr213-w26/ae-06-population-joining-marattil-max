...
Asia an Africa will have the highest and second highest population respectively. Antartica will have the lowest.  
...
ggplot(population_summary, aes())+
  ...
  labs(
    ...
    x = "Total Population",
    y = "Continent",
    captions = "Data sources: The World Bank and Our World in Data"
  )+ scale_x_continuous(label = label_number(scale = 1/1000000, suffix = " bil"))
...
-   **Think out loud:** What additional improvements would you like to make to this plot.
   ...
   - ordering the data in desending order